...
<!-- 						<li><a href="LoginPage.jsp"> Table Login </a></li> -->
			...
			<form action="control?action=login" method="post">
				<table
					...
					<tr>
						<td colspan="2" bgcolor="teal" style="text-align: center; font-size: 15px ">
							Login to My Hotel </td>
					</tr>
					<tr></tr>
					<%
		...
		<div id="templatemo_footer">
			...
			2018 <a href="AboutUs.html"><strong> My Hotels Group. All rights reserved. </strong></a>
		</div>
		<!-- end of footer -->
