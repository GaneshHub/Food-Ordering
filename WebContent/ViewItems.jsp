...
Login login = (Login) session.getAttribute(GlobalConstants.USER); 
		Integer catgId = Integer.parseInt(request
				.getParameter("catId"));
	if (catgId != null)
		cats = new UserService().getAllItems(catgId);
	ArrayList<Item> items = cats;
...
<body>
	...
	<div id="templatemo_container">
			...
			<div id="templatemo_content_right">
				<form action="cook?action=makeOrder" method="post">
					...
					Order Name : <input type="text" name="orderName" value="" /> <input
						type="hidden" name="tableNo" value="<%=login.getId()%>" /> 
						<input type="submit"
						value="Order" /> 
						<input type="reset" />
				</form>
		...
		<div id="templatemo_footer">
			...
			2018 <a href="AboutUs.html"><strong>My Project Details </strong></a>
